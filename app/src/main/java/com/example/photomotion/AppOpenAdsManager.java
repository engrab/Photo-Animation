package com.example.photomotion;
...
import com.example.photomotion.activity.SplashActivity;
import com.example.photomotion.utils.AppHelper;
...
public class AppOpenAdsManager implements LifecycleObserver, Application.ActivityLifecycleCallbacks {
    ...
    public void fetchAd() {
        ...
        loadCallback = new AppOpenAd.AppOpenAdLoadCallback() {
            ...
            String adUnitId = myApplication.getString(R.string.ad_mob_app_open_id);
            if (adUnitId == null) {
                return;
            }
            if (adUnitId.isEmpty()) {
